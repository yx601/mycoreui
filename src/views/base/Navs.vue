  ...
  <div class="wrapper">
    <div class="animated fadeIn">
      ...
      <b-card
        ...
        <div>
          <b-nav tabs>
            <b-nav-item key="navs1" :active="currentTab=='navs1'?true:false" @click="currentTab='navs1'" >Active</b-nav-item>
            <b-nav-item key="navs2" :active="currentTab=='navs2'?true:false" @click="currentTab='navs2'">Link</b-nav-item>
            <b-nav-item key="navs3" :active="currentTab=='navs3'?true:false" @click="currentTab='navs3'">Another Link</b-nav-item>
            <b-nav-item key="navs4" :active="currentTab=='navs4'?true:false" @click="currentTab='navs4'">Disabled</b-nav-item>
          </b-nav>
        </div>
      </b-card>
      <b-card
      ...
      <b-card
        ...
        footer-tag="footer">
        <div slot="header">
          <i class="fa fa-align-justify"></i><strong>{{currentTab}} </strong><small>justified tabs</small>
        </div>
        <div>
