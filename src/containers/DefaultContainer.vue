  ...
  <div class="app">
    <AppHeader fixed>
      ...
      <b-link class="navbar-brand" to="#">
        ...
        <img class="navbar-brand-minimized" src="img/logo_s.png" width="30" height="30" alt="CoreUI Logo">
      </b-link>
      <SidebarToggler class="d-md-down-none" display="lg" />
      <b-navbar-nav class="d-md-down-none">
        <b-nav-item class="px-3" to="/dashboard">仪表盘</b-nav-item>
...
import SidebarNav from './mysidebar'
